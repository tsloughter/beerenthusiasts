...
N.Page = function(o) {
	...
	n.$do_sync_event = n.$do_sync_xhr_event;
...
N.$run_event = function(triggerID, postbackInfo, extraParams) {
	  var n = Nitrogen.$lookup(Nitrogen.$current_id);
	  return n.$do_sync_event(triggerID, postbackInfo, extraParams);
}
...
N.prototype.$do_sync_xhr_event = function(triggerID, postbackInfo, extraParams) {
	// Flag to prevent firing multiple postbacks at the same time...
	Nitrogen.$event_is_running = true;
